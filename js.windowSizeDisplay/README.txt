...
NOTE: Anything within *s like... *text* --> means you can replace everything within (including the *s) with whatever YOU DECIDE TO NAME IT. In fact you usually DO NOT include *s as part of the String values of these attributes.
